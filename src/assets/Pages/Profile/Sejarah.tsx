...
const Sejarah = () => {
  return (
    <div className="bg-white  min-h-fullscreen text-black tracking-wide">
      <Header />
      <div className="font-open-sans pt-10 pl-20 max-w-250 text-sm text-gray-500">
        <h1 className="text-black text-4xl/tight pb-6">Sejarah Instansi</h1>
        <p className="">
          ...
          located in the industrial area in Sumengko-Wringinanom (Gresik), about
          30 kilometers from the city of Surabaya with its Tanjung Perak Sea
          Port, one of the busiest ports in Indonesia.
        </p>
        <br />
        <p>
          ...
          products of PT. Ever Age Valves Metals are mainly for export purposes.
        </p>
        <br />
        <p>
          ...
          assure that its products will be delivered in the best of its quality.
        </p>
        <br />
        <p>
        ...
        <ul className="pl-4">
          ...
          <br />
          <li>
            <strong>Assembling Departments</strong>: Air pressure equipments to
            test the pressure of air, water and steam.
          </li>
          <br />
          <li>
